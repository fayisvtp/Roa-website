        ...
        <div className='wrapper'>
          ...
          <div className='footer-nav'>
            ...
            <div className='footer-nav__col'>
              ...
              <ul>
                <li>
                  <i className='icon-map-pin'></i> 1st Floor, MallAslam, KSHB Colony, Perinthalmanna, Kerala 679322
                </li>
                <li>
                  <i className='icon-smartphone'></i>
                  <div className='footer-nav__col-phones'>
                    <a href='tel:+91 82228 99916'>+91 82228 99916</a>
                    {/* <a href='tel:‪+91 82228 99916‬'>+1 345 74 64 975</a> */}
                  </div>
                </li>
                <li>
                  <i className='icon-mail'></i>
                  <a href='mailto:info@roadiamonds.com'>info@roadiamonds.com</a>
                </li>
              </ul>
            </div>
          </div>
          <div className='footer-copy'>
            <span>&copy; All rights reserved. Roa Diamond 2024</span>
          </div>
        </div>
      </footer>
      {/* <!-- FOOTER EOF   --> */}
